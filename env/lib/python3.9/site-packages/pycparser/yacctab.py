...
_lr_goto_items = {
    ...
    "init_declarator_list": ([4, 89,], [70, 70,]),
    "init_declarator_list_opt": ([4, 89,], [79, 79,]),
    "iteration_statement": (
        [181, 298, 307, 429, 437, 440, 502, 535, 537, 539, 569, 574, 577,],
    ...
    "static_assert": (
        ...
        [17, 17, 286, 286, 286, 286, 286, 286, 286, 286, 286, 286, 286, 286, 286,],
    ),
    ...
    "typeid_noparen_declarator": ([211,], [348,]),
    "type_qualifier_list_opt": (
        [35, 117, 128, 206, 220, 282, 459, 515,],
        [104, 204, 218, 339, 354, 419, 513, 543,],
    ),
    "declaration_specifiers_no_type_opt": (
        [1, 27, 52, 53, 55, 63, 87,],
        [66, 94, 120, 121, 122, 94, 94,],
    ),
    "expression_opt": (
        [
            181,
    ...
    "translation_unit": ([0,], [59,]),
    "init_declarator": ([4, 89, 126, 202,], [84, 84, 217, 331,]),
    "direct_abstract_declarator": (
        [177, 211, 276, 278, 342, 344, 457,],
        [283, 283, 414, 283, 283, 414, 414,],
    ),
    "designator_list": ([227, 472, 488, 550,], [376, 376, 376, 376,]),
    "identifier": (
        [
            85,
            116,
    ...
    "offsetof_member_designator": ([485,], [526,]),
    "unary_expression": (
        [
            85,
            116,
    ...
    "initializer": ([131, 201, 375, 521,], [226, 330, 473, 546,]),
    ...
    "pp_directive": ([0, 59,], [14, 14,]),
    "declaration_list": ([21, 75,], [93, 93,]),
    "id_init_declarator": ([40, 91,], [108, 108,]),
    "type_specifier": (
        [
            0,
            21,
    ...
    "storage_class_specifier": (
        ...
        [1, 1, 68, 1, 1, 1, 1, 1, 1, 1, 1, 1, 68, 1, 1, 1, 1, 68, 1, 1, 1, 1, 1, 1, 1,],
    ),
    "unified_wstring_literal": (
        [
            85,
    ...
    "translation_unit_or_empty": ([0,], [9,]),
    "initializer_list_opt": ([227,], [370,]),
    "brace_close": (
        [99, 184, 185, 186, 196, 309, 313, 315, 325, 326, 370, 472, 528, 550,],
        [187, 314, 316, 317, 328, 439, 442, 443, 448, 449, 469, 523, 551, 565,],
    ),
    "direct_typeid_declarator": (
        [4, 69, 72, 89, 126, 192, 202, 445,],
        [73, 73, 127, 73, 73, 73, 73, 73,],
    ),
    "external_declaration": ([0, 59,], [16, 123,]),
    "pragmacomp_or_statement": (
        [307, 429, 440, 502, 535, 537, 539, 569, 574, 577,],
        [436, 500, 506, 536, 554, 555, 557, 576, 578, 579,],
    ),
    "type_name": (
        [85, 95, 174, 229, 231, 233, 239, 267,],
        [157, 183, 271, 379, 380, 381, 382, 410,],
    ),
    "typedef_name": (
        [
            0,
    ...
    "struct_declarator_list": ([192,], [320,]),
    "empty": (
        [
            0,
            1,
    ...
    "parameter_declaration": (
        [118, 129, 278, 342, 350, 422, 460,],
        [210, 210, 210, 210, 463, 210, 210,],
    ),
    "primary_expression": (
        [
            85,
    ...
    "declaration": (
        [0, 21, 59, 75, 93, 181, 298, 427,],
        [38, 90, 38, 90, 182, 302, 302, 499,],
    ),
    ...
    "enumerator_list": ([102, 193, 194,], [196, 325, 326,]),
    "block_item": ([181, 298,], [305, 432,]),
    "constant_expression": (
        [85, 116, 297, 319, 329, 373, 447,],
        [159, 203, 431, 444, 451, 471, 509,],
    ),
    "identifier_list_opt": ([118, 129, 460,], [207, 221, 516,]),
    "constant": (
        [
            85,
            116,
    ...
    "struct_declaration": (
        [99, 184, 185, 186, 313, 315,],
        [190, 190, 190, 318, 318, 318,],
    ),
    "direct_typeid_noparen_declarator": ([211, 344,], [345, 458,]),
    "id_declarator": (
        [0, 4, 37, 40, 59, 69, 89, 91, 126, 192, 202, 211, 342, 445,],
        [21, 75, 107, 110, 21, 107, 179, 110, 179, 179, 179, 346, 107, 179,],
    ),
    "selection_statement": (
        [181, 298, 307, 429, 437, 440, 502, 535, 537, 539, 569, 574, 577,],
    ...
    "initializer_list": ([227, 488,], [374, 528,]),
    "unary_operator": (
        [
            85,
            116,
    ...
    "designation_opt": ([227, 472, 488, 550,], [375, 521, 375, 521,]),
    "parameter_type_list": (
        [118, 129, 278, 342, 422, 460,],
        [209, 222, 416, 416, 416, 517,],
    ),
    "type_qualifier_list": (
        [
            35,
    ...
    "designator": ([227, 376, 472, 488, 550,], [371, 474, 371, 371, 371,]),
    "id_init_declarator_list_opt": ([40, 91,], [114, 114,]),
    ...
    "declaration_list_opt": ([21, 75,], [92, 130,]),
    "function_definition": ([0, 59,], [45, 45,]),
    "binary_expression": (
        [
            85,
            116,
    ...
    "specifier_qualifier_list": (
        ...
        [177, 177, 192, 177, 192, 192, 192, 177, 177, 177, 177, 177, 192, 192,],
    ),
