...
class AccountTests(TestCase):
    ...
    def test_password_reset_flow_with_another_user_logged_in(self):
        ...
        resp = self.client.post(
            reverse("account_login"), {"login": user2.email, "password": "doe",},
        )
    ...
    def test_login_failed_attempts_exceeded_cleared_on_password_reset(self):
        ...
        self.assertFormError(
            resp, "form", None, "Too many failed login attempts. Try again later.",
        )
        ...
        resp = self.client.post(
            reverse("account_login"), {"login": user.email, "password": new_password},
        )
...
class EmailFormTests(TestCase):
    ...
    def test_verify_unknown_email(self):
        ...
        self.client.post(
            reverse("account_email"), {"action_send": "", "email": "email@unknown.org"},
        )
