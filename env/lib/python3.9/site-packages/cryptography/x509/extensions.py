...
def _key_identifier_from_public_key(public_key: CERTIFICATE_PUBLIC_KEY_TYPES,) -> bytes:
...
class AuthorityKeyIdentifier(ExtensionType):
    ...
    @property
    def authority_cert_issuer(self,) -> typing.Optional[typing.List[GeneralName]]:
...
class NameConstraints(ExtensionType):
    ...
    @property
    def permitted_subtrees(self,) -> typing.Optional[typing.List[GeneralName]]:
...
class GeneralNames:
    ...
    @typing.overload
    def get_values_for_type(
        self, type: typing.Type[DirectoryName],
    ) -> typing.List[Name]:
        ...

    @typing.overload
    def get_values_for_type(
        self, type: typing.Type[RegisteredID],
