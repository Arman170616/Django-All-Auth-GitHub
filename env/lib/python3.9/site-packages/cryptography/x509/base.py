...
class CertificateSigningRequestBuilder:
    ...
    def add_extension(
        ...
        return CertificateSigningRequestBuilder(
            self._subject_name, self._extensions + [extension], self._attributes,
        )
...
class CertificateBuilder:
    ...
    def public_key(self, key: CERTIFICATE_PUBLIC_KEY_TYPES,) -> "CertificateBuilder":
        """
...
class RevokedCertificateBuilder:
    ...
    def add_extension(
        ...
        _reject_duplicate_extension(extension, self._extensions)
        return RevokedCertificateBuilder(
            self._serial_number, self._revocation_date, self._extensions + [extension],
        )
    ...
    def build(self, backend: typing.Any = None) -> RevokedCertificate:
        ...
        return _RawRevokedCertificate(
            self._serial_number, self._revocation_date, Extensions(self._extensions),
        )
