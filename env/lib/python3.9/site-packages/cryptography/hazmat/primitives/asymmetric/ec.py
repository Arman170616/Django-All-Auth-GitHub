...
class EllipticCurvePublicKey(metaclass=abc.ABCMeta):
    ...
    @abc.abstractmethod
    def public_bytes(
        self, encoding: _serialization.Encoding, format: _serialization.PublicFormat,
    ) -> bytes:
        """
        Returns the key serialized as bytes.
        """
...
class ECDSA(EllipticCurveSignatureAlgorithm):
    def __init__(
        self, algorithm: typing.Union[asym_utils.Prehashed, hashes.HashAlgorithm],
    ):
...
def derive_private_key(
    private_value: int, curve: EllipticCurve, backend: typing.Any = None,
) -> EllipticCurvePrivateKey:
    from cryptography.hazmat.backends.openssl.backend import backend as ossl
