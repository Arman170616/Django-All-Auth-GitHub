...
def _wrap_core(wrapping_key: bytes, a: bytes, r: typing.List[bytes],) -> bytes:
...
def aes_key_wrap(
    wrapping_key: bytes, key_to_wrap: bytes, backend: typing.Any = None,
) -> bytes:
...
def aes_key_unwrap_with_padding(
    wrapping_key: bytes, wrapped_key: bytes, backend: typing.Any = None,
) -> bytes:
