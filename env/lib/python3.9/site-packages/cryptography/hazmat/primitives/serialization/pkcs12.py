...
class PKCS12Certificate:
    def __init__(
        self, cert: x509.Certificate, friendly_name: typing.Optional[bytes],
    ):
...
_PKCS12_CAS_TYPES = typing.Union[
    x509.Certificate, PKCS12Certificate,
]
...
def serialize_key_and_certificates(
    ...
    if cas is not None:
        cas = list(cas)
        if not all(
            isinstance(val, (x509.Certificate, PKCS12Certificate,),) for val in cas
        ):
